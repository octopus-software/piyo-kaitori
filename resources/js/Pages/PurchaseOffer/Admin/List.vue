                    ...
                    <tr v-for="(purchase_offer, index) in purchase_offers" :key="index"
                        ...
                        <td class="px-6 py-4 font-medium whitespace-nowrap dark:text-white">
                            <div class="flex inline-block">
                                <svg @click="goEdit(purchase_offer.id)" class="cursor-pointer mr-4 w-6 h-6 text-blue-400 dark:text-white hover:text-blue-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
